...
export default function Payments() {
  ...
  React.useEffect(() => {
    if (!paymentFromStore) dispatch(getPayments());
  }, [paymentFromStore]);
  ...
  return (
    <>
      <Subheader text={"Payment lists"} route={"/dashboard/"}></Subheader>
      <div className="Payments">
        <div className="container">
          {paymentFromStore?.length ? (
            paymentFromStore?.map((item) => {
              return (
                <Card className="booking-card">
                    ...
                    subheader={
                      <>
                        <div className="date">
                          ...
                          <p>{moment(item?.time).format("Do MMM YY")}</p>
                        </div>
                        <div className="time">
                          <IconButton color="primary">
                  ...
                  >
                    ...
                    <Chip label={"₹"+item.amount} color="primary" />
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    <div className="mode"><PaymentsIcon></PaymentsIcon><p>Cash</p></div>
                    <Button
                      variant="text"
                      color="primary"
                      disabled
