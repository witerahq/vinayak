                ...
                <Card className="booking-card">
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center" }}>
                      <Avatar sx={{ width: 50, height: 50 }} src={item.doctorId.image}>{item.doctorId.fullName}</Avatar>
                  ...
                  <div style={{ display: "flex", alignItems: "center" }} className="patient-detail">
                    <Avatar sx={{ width: 25, height: 25,fontSize:14}} src={item.patientId.image}>{item.patientId.fullName}</Avatar>
                    <Typography
                      variant="body1"
                      color="textPrimary"
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center" }}>
                      ...
                      <Typography variant="body1" fontSize={14} color="textPrimary" className="type">
                       {item.mode}
                      </Typography>
                    </div>
                    <Button variant="text" color="primary" sx={{fontSize:14,textTransform:'unset'}} endIcon={<KeyboardArrowRightIcon />} onClick={e=>(navigate('/booking/'+item?._id))}>
                      View Details
                    </Button>
                  </div>
                </Card>
